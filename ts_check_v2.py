...
def main():
    ...
    my_parser.add_argument('-x','--xfree', action='store', type=str, required=True, help='Location of xfreerdp executable.')
    ...
    exec_module.actions(pyautogui, resilienceValue, confidenceValue, debug, disp, interval, failure_search_buttom, failure_search)
